                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'transaction_id'">{{ trans('admin.user.columns.transaction_id') }}</th>
                                        <th is='sortable' :column="'deposit'">{{ trans('admin.user.columns.deposit') }}</th>
                                        <th is='sortable' :column="'balance'">{{ trans('admin.user.columns.balance') }}</th>
